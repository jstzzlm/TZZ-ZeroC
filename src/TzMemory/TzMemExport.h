 ...
 * MA 02110-1301 USA.
 */
#ifndef TZZEROC_TZMEMORY_TZMEMEXPORT_H
#define TZZEROC_TZMEMORY_TZMEMEXPORT_H

#ifdef WIN32
#  ifdef TZMEMORY_EXPORT
#    define TZMEM_API(rettype)    extern __declspec(dllexport) rettype __stdcall 
#  else
#    define TZMEM_API(rettype)    extern __declspec(dllimport) rettype __stdcall
#  endif
#else
#  define TZMEM_API(rettype)     extern rettype __stdcall 
#endif
