 ...
 * MA 02110-1301 USA.
 */
#ifndef TZZEROC_TZDS_TZDSEXPORT_H
#define TZZEROC_TZDS_TZDSEXPORT_H

#ifdef WIN32
#  ifdef TZDS_EXPORT
#    define TZDS_API(rettype)    extern __declspec(dllexport) rettype __stdcall 
#  else
#    define TZDS_API(rettype)    extern __declspec(dllimport) rettype __stdcall 
#  endif
#else
