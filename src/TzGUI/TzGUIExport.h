 ...
 * MA 02110-1301 USA.
 */
#ifndef TZZEROC_TZGUI_TZGUIEXPORT_H
#define TZZEROC_TZGUI_TZGUIEXPORT_H

#ifdef WIN32
#  ifdef TZGUI_EXPORT
#    define TZGUI_API(rettype)    extern __declspec(dllexport) rettype __stdcall
#  else
#    define TZGUI_API(rettype)    extern __declspec(dllimport) rettype __stdcall
#  endif
#else
#  define TZGUI_API(rettype)     extern rettype __stdcall
#endif
