 ...
 * MA 02110-1301 USA.
 */
#ifndef TZZEROC_TZMATH_TZMATHEXPORT_H
#define TZZEROC_TZMATH_TZMATHEXPORT_H

#include <stdint.h>

#ifdef WIN32
#  ifdef TZMATH_EXPORT
#    define TZMATH_API(rettype)    extern __declspec(dllexport) rettype __stdcall 
#  else
#    define TZMATH_API(rettype)    extern __declspec(dllimport) rettype __stdcall 
#  endif
#else
#  define TZMATH_API(rettype)     extern rettype __stdcall 
#endif
