...
char * __stdcall tz_strnew(const char *s)
{
    return 0;
}

char * __stdcall tz_strcpy(char *ds, const char *ss)
{
    return 0;
}

uint32_t __stdcall tz_strlen(const char *s)
{
    return 0;
}

char * __stdcall tz_strstr(const char *s, const char *search)
{
    return 0;
}